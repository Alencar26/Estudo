...
type CategoryServiceClient interface {
	// Jeito tradicional (request/response) igual REST
	CreateCategory(ctx context.Context, in *CreateCategoryRequest, opts ...grpc.CallOption) (*Category, error)
	// Abaixo temos um exemplo de como abrir um canal de comunicação com gRPC
	// Abrimos um canal (stream) onde passaremos tudo que queremos e recebemos tudo de uma vez
	...
	// Abaixo temos um exemplo de como trabalhar com stream de dados no gRPC
